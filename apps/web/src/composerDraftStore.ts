...
function normalizeProviderModelOptions(
  ...
  const result: ProviderOptionSelectionsByProvider = {};
  for (const providerKey of ["codex", "claudeAgent", "cursor", "opencode", "openrouter"] as const) {
...
function legacyToModelSelectionByProvider(
  ...
  if (modelOptions) {
    for (const provider of ["codex", "claudeAgent", "cursor", "opencode", "openrouter"] as const) {
