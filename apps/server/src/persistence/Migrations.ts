...
import Migration0050 from "./Migrations/050_ManagedGoals.ts";
import Migration0051 from "./Migrations/051_ScheduledLoops.ts";
import Migration0052 from "./Migrations/052_ScheduledLoopCorrelation.ts";
import Migration0053 from "./Migrations/053_ThreadParent.ts";
import Migration0054 from "./Migrations/054_ManagedGoalIdentity.ts";
import Migration0055 from "./Migrations/055_MessageVersions.ts";
...
const migrationEntries = [
  ...
  [50, "ManagedGoals", Migration0050],
  [51, "ScheduledLoops", Migration0051],
  [52, "ScheduledLoopCorrelation", Migration0052],
  [53, "ThreadParent", Migration0053],
  [54, "ManagedGoalIdentity", Migration0054],
  [55, "MessageVersions", Migration0055],
] as const;
