...
import { ModelSelection, ThreadLinkedPullRequest, MessageVersion } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.messageVersion ? JSON.stringify(row.messageVersion) : null},
          ${row.title},
        ...
        DO UPDATE SET
          ...
          message_version_json = excluded.message_version_json,
