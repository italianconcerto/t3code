...
import { createEnvironmentRpcQueryAtomFamily, createEnvironmentRpcCommand } from "./runtime.ts";
...
export function createOrchestrationEnvironmentAtoms<R, E>(
  ...
  return {
    subagent: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:provider:subagent",
      tag: WS_METHODS.providerSubagent,
    }),
